  ...
  return (
    <div className="px-4 py-6">
      <div className="flex items-center justify-between mb-4">
        ...
        <Link href="/info" className="text-sky text-sm font-medium">
          see all
        </Link>
      </div>
      ...
      <div className="grid grid-cols-3 gap-2">
        {displayItems.map((item) => (
          <Link
            key={item.id}
            href={`/info/${item.slug}`}
            className="card card-hover p-3 flex flex-col items-center text-center"
          >
            <div className="w-10 h-10 rounded-lg bg-sky-light text-sky flex items-center justify-center mb-2">
              {iconMap[item.slug] || (
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <circle cx="12" cy="12" r="10" />
